...
class StringTest {
    ...
    void should_break_string_into_words() {
        ...
        words[0] = sentence.substring(0,4);
        words[1] = sentence.substring(5,7);
        words[2] = sentence.substring(8,12);
        // --End-->
    ...
    void should_reverse_a_string() {
        ...
        final String reversed = word.reverse().toString();
        // --End-->
